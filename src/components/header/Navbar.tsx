  ...
  return (
    <nav className="order-last lg:order-none">
      ...
      <ul
        ...
        } top-0 px-10 py-20 lg:p-0 bg-background lg:bg-transparent transition-all duration-200 h-full lg:h-auto flex-col lg:flex-row w-full lg:w-auto flex items-start lg:items-center gap-2`}
      >
        <Button
          variant="secondary"
          size="sm"
